...
./constants ./demos/lir/constants-1.lir test > ./demos/std_const_out/constants-1.const.out
./constants ./demos/lir/constants-2.lir test > ./demos/std_const_out/constants-2.const.out
./constants ./demos/lir/constants-3.lir test > ./demos/std_const_out/constants-3.const.out
...
./constants_analysis ./demos/json/constants-1.json test > ./demos/const_out/constants-1.const.out
./constants_analysis ./demos/json/constants-2.json test > ./demos/const_out/constants-2.const.out
./constants_analysis ./demos/json/constants-3.json test > ./demos/const_out/constants-3.const.out
